<?php
/**
 * Template Name: Minuta para venda Laser Usada 07-11-2019
 * Version: 0.2
 ...
 * Tags: contrato, minuta, laser, usada
 */
...
Estado de Conservação: <strong>{Estado de Conservação:49}</strong><br>
</span></p>
...
<p style="text-align: justify;"><strong>6.1.</strong> <span style="font-weight: 400;">A <strong>VENDEDORA</strong> obriga-se a prestar à <strong>COMPRADORA</strong> garantia técnica à dita Máquina, pelo prazo de 1 (mês) e 1 (mês) para tubo de laser e fontes, contados da data de assinatura deste Contrato, ressalvados os casos de exclusão ou extensão da garantia.  Havendo assistência técnica os encargos de locomoção efetuado pela <strong>COMPRADORA</strong> terá uma validade de 1 (mês).</span></p>
