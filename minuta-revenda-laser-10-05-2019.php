<?php
/**
 * Template Name: Minuta para revenda Laser 10-05-2019
 * Version: 0.5
...
<p style="text-align: justify;"><strong>4.1.</strong> <span style="font-weight: 400;">A <strong>VENDEDORA</strong> obriga-se a prestar à <strong>REVENDEDORA</strong> garantia técnica à dita Máquina, pelo prazo de 12 (meses) e 3 (meses) para tubo de laser e fontes, contados da data de assinatura deste Contrato, ressalvados os casos de exclusão ou extensão da garantia.</span></p>
...
<p style="text-align: justify;"><span style="font-weight: 400;"><strong>re</strong></span></p>
