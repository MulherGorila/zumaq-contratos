<?php
/**
 * Template Name: Minuta para venda Plotter 07-01-2019
 * Version: 0.2
 * Description: Modelo básico de minuta para venda de máquina plotter
 * Author: Tiago Cordeiro
 * Author URI: https://www.mulhergorila.com
 * Group: Contratos Zumaq
 * License: GPLv2
 * Required PDF Version: 4.0
 * Tags: contrato, minuta, plotter
 */
...
<p style="text-align: justify;"><strong>6.1.</strong> <span style="font-weight: 400;">A <strong>VENDEDORA</strong> obriga-se a prestar à <strong>COMPRADORA</strong> garantia técnica à dita Máquina, pelo prazo de 12 (meses), contados da data de assinatura deste Contrato, ressalvados os casos de exclusão ou extensão da garantia. Havendo assistência técnica os encargos de locomoção efetuado pela <strong>COMPRADORA</strong> terá uma validade de 1 (meses).</span></p>
...
<p style="text-align: justify;"><strong>8.2.</strong> <span style="font-weight: 400;">A Máquina Plotter não tem necessidade de instalação, temos vídeo aula no YouTube e manual em português, desde instalação da máquina ou software.</span></p>

<p style="text-align: justify;"><strong>8.3.</strong> <span style="font-weight: 400;">É de obrigação da <strong>COMPRADORA</strong> uma estrutura para adquirir a Máquina Plotter. Computador com entrada USB, 110V com neutro ou 220V com aterramento, ambiente até 30º</span></p>
