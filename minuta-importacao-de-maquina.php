<?php
/**
 * Template Name: AD Minuta para importação de máquina
 * Version: 0.0.1
 * Description: Modelo básico de minuta para importação de máquina
...
<h1 style="font-size: 18px; padding: 0px 40px 10px 40px;">CONTRATO PARA IMPORATAÇÃO DE MÁQUINA</h1>
...
VALOR RESERVA (50%) SOBRE O TOTAL: {Valor de Reserva (50% sobre o total):56}<br/>
