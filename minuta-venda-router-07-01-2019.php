<?php
/**
 * Template Name: Minuta para venda Router 07-01-2019
 * Version: 0.2
 * Description: Modelo básico de minuta para venda de máquina router
 * Author: Tiago Cordeiro
 * Author URI: https://www.mulhergorila.com
 * Group: Contratos Zumaq
 * License: GPLv2
 * Required PDF Version: 4.0
 * Tags: contrato, minuta, router
 */
...
<p style="text-align: justify;"><strong>8.3.</strong> <span style="font-weight: 400;">É de obrigação da <strong>COMPRADORA</strong> uma estrutura para adquirir a Maquina Router. Ambiente climatizado de até 30ºC, Aterramento, Computador com entrada PCI, duas Linhas separadas e alimentada direto da entrada de corrente fornecida pela companhia de Energia Elétrica.</span></p>
