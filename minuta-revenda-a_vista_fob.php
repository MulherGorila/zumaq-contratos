<?php
/**
 * Template Name: Minuta para revenda a vista FOB
 * Version: 0.1
...
<p style="text-align: justify;"><span style="font-weight: 400;"><strong>O presente contrato com a totalidade de suas cláusulas, terá validade para compras efetuadas pela COMPRADORA durante o corrente ano e a findar na data de 31 de dezembro de 2021.</strong></span></p>

<p style="text-align: justify;">&nbsp;</p>

<p><span style="font-weight: 400;">Ass: COMPRADOR(A)______________________________________________________________________________</span></p>
...
echo "Santo André, SP " . "$dia de $nomemes de $ano";
