<?php
/**
 * Template Name: Minuta para venda Laser 27-03-2019
 * Version: 0.4
 * Description: Modelo básico de minuta para venda de máquina laser
...
<h1 style="font-size: 24px; padding: 0px 40px 15px 40px;">CONTRATO DE COMPRA E VENDA DE EQUIPAMENTO COM RESERVA DE DOMÍNIO</h1>
...
<p style="text-align: justify;"><strong>6.1.</strong> <span style="font-weight: 400;">A <strong>VENDEDORA</strong> obriga-se a prestar à <strong>COMPRADORA</strong> garantia técnica à dita Máquina, pelo prazo de 12 (meses) e 3 (meses) para tubo de laser e fontes, contados da data de assinatura deste Contrato, ressalvados os casos de exclusão ou extensão da garantia.  Havendo assistência técnica os encargos de locomoção efetuado pela <strong>COMPRADORA</strong> terá uma validade de 1 (mês).</span></p>
